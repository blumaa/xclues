...
export var VALID_GENRES = ['films', 'music', 'sports', 'books'];
export var DEFAULT_GENRE = 'films';
export function isValidGenre(value) {
    return !!value && VALID_GENRES.includes(value);
}
export function getSeoConfig(genre) {
